...
<template>
  <div class="h-full flex bg-forge-950">
    ...
    <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center">
      <!-- Gradient background -->
      <div class="absolute inset-0 bg-gradient-to-br from-ember/20 via-forge-950 to-violet-500/10"></div>
      <div class="absolute inset-0 bg-[radial-gradient(ellipse_at_30%_20%,rgba(99,102,241,0.16),transparent_60%)]"></div>

      <div class="relative z-10 px-16 max-w-lg">
        <!-- Logo -->
        <div class="flex items-center gap-4 mb-10">
          <img src="/flowmancer-icon.png" alt="Flowmancer" class="w-14 h-14" />
    ...
    <div class="flex-1 flex items-center justify-center px-6">
      <div class="w-full max-w-sm">
        ...
        <div class="lg:hidden flex items-center justify-center gap-3 mb-10">
          <img src="/flowmancer-icon.png" alt="Flowmancer" class="w-10 h-10" />
        ...
        <button
          @click="handleGoogle"
          :disabled="submitting"
          class="w-full flex items-center justify-center gap-3 bg-forge-900 border border-forge-700/50 rounded-xl px-4 py-3 text-sm font-medium text-forge-100 shadow-soft hover:bg-forge-850 hover:border-forge-600/50 hover:-translate-y-0.5 transition-all duration-200 cursor-pointer disabled:opacity-50 mb-6"
        >
